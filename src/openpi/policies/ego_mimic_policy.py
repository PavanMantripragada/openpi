...
class EgoMimicInputs(transforms.DataTransformFn):
    """
    ...
    def __call__(self, data: dict) -> dict:
        ...
        # For pi0-FAST, we don't pad the state. For ego_mimic, we don't need to differentiate
...
@dataclasses.dataclass(frozen=True)
class EgoMimicOutputs(transforms.DataTransformFn):
    """
